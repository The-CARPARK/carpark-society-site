      ...
      <Layout>
        <div className="flex flex-col items-center justify-center min-h-[70vh] text-center space-y-6 text-white">
          ...
          <p className="text-sm text-gray-500 italic">
            Loop Condition: <span onClick={handleLevelClick} className="cursor-pointer hover:text-red-400 transition-all">
          ...
          <div className="pt-10 max-w-xl text-xs text-gray-500 space-y-2">
            ...
            <p>⋔ All Watchers are accounted for. Yet the feed remains active.</p>
